...
class add_record_adhoc_task extends \core\task\adhoc_task {

    public function execute() {
        // self::send_mail_or_notification();
        ...
        $forumpostsid = $data->forumpostsid;
        $mailed       = $data->mailed;
        $mailnow      = $data->mailnow;
        ...
        $DB->insert_record('local_th_notification_forum', $object);
    }
}