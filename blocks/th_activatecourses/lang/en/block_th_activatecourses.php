...
$string['past'] = 'Past';
$string['pluginname'] = 'Unactivated Courses';
...
$string['breadcrumb'] = 'Activate Course';
$string['heading'] = 'Activate Course';
$string['activepagetitle'] = 'Activate Course';
...
$string['activatecourse'] = 'Activate course';
$string['activate'] = 'Activate';
$string['regisredcourseshortname'] = 'Registered Course Field ShortName';
$string['activateconfirm'] = 'The course {$a->course} is valid for {$a->duration} from the datetime of activation. Are you sure you want to active now?';
$string['activateconfirm_nolimit'] = 'Are you sure you want to active now?';
