...
[
    'jquery',
    'block_th_activatecourses/repository',
    ...
    'core/templates',
    'core_course/events',
    'block_th_activatecourses/selectors',
...
function(
    ...
    var TEMPLATES = {
        COURSES_CARDS: 'block_th_activatecourses/view-cards',
        COURSES_LIST: 'block_th_activatecourses/view-list',
        COURSES_SUMMARY: 'block_th_activatecourses/view-summary',
    ...
    var NUMCOURSES_PERPAGE = [3, 6, 9, 12, 0];
    ...
    var DEFAULT_PAGED_CONTENT_CONFIG = {
        ...
        persistentLimitKey: 'block_th_activatecourses_user_paging_preference'
    };
    ...
    var setCourseHiddenState = function(courseId, status) {
        ...
        return Repository.updateUserPreferences({
            preferences: [
                {
                    type: 'block_th_activatecourses_hidden_course_' + courseId,
                    value: status
                }
            ]
        });
    ...
    var initializePagedContent = function(root) {
        namespace = "block_th_activatecourses_" + root.attr('id') + "_" + Math.random();
        ...
        console.log("totalCourseCount 22:");
            ...
            function(pagesData, actions) {
                ...
                pagesData.forEach(function(pageData) {
                    ...
                    var pagePromise = getMyCourses(
                        ...
                        console.log("hello here11");
                        console.log(coursesData);

                        var courses = coursesData.courses;
                        // currentPage = pagenumber
                        var pageoffset = pageData.offset;
                        var pagelimit = pageData.limit;


                        if(pagelimit > 0)
                        {

                            var temp = totalCourseCount / pagelimit;
                            console.log("temp:");
                            console.log(temp);

                            var numberofpageneed = Math.ceil(totalCourseCount / pagelimit);
                            console.log(numberofpageneed);


                            lastPage = numberofpageneed;

                            for (var i = 1; i <= numberofpageneed; i++) {


                                startpageindex = pagelimit*(i-1);                            
                                var nextpagestart = startpageindex+pagelimit;
                                if(nextpagestart>totalCourseCount) nextpagestart = totalCourseCount;


                                console.log(pageoffset);
                                console.log(nextpagestart);

                                pageCourses = courses.slice(startpageindex,nextpagestart);
                                loadedPages[i] = {
                                    courses: pageCourses
                                };
                            }
                        ...
                        console.log(loadedPages[currentPage]);
    ...
    /**
     * Listen to, and handle events for  the th_activatecourses block.
     *
     * @param {Object} root The th_activatecourses block container element.
     */
