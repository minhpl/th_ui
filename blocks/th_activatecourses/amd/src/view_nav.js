...
function(
    ...
    var updatePreferences = function(filter, value) {
        var type = null;
        if (filter == 'display') {
            type = 'block_th_activatecourses_user_view_preference';
        } else if (filter == 'sort') {
            type = 'block_th_activatecourses_user_sort_preference';
        } else if (filter == 'customfieldvalue') {
            type = 'block_th_activatecourses_user_grouping_customfieldvalue_preference';
        } else {
            type = 'block_th_activatecourses_user_grouping_preference';
        }
     ...
     *
     * @param {object} root The root element for the th_activatecourses block
     */
