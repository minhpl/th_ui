...
Feature: The my overview block allows users to group courses by custom fields
  ...
  Scenario: Group courses by checkbox: Yes
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1             | block_th_activatecourses |
      | customfiltergrouping       | checkboxfield | block_th_activatecourses |
  ...
  Scenario: Group courses by date: 1 February 2001
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_th_activatecourses |
      | customfiltergrouping       | datefield | block_th_activatecourses |
    And I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
  ...
  Scenario: Group courses by select: Option 1
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1           | block_th_activatecourses |
      | customfiltergrouping       | selectfield | block_th_activatecourses |
    And I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
  ...
  Scenario: Group courses by text: fish
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_th_activatecourses |
      | customfiltergrouping       | textfield | block_th_activatecourses |
    And I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
  ...
  Scenario: Hidden fields not displayed in the filter
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1          | block_th_activatecourses |
      | customfiltergrouping       | textfield2 | block_th_activatecourses |
